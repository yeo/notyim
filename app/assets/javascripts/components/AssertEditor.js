...
var _user$project$AssertEditor$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SelectSubject':
				var updateAssert = function (a) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							assert: updateAssert(model.assert)
						}),
			...
			default:
				...
				var foo = _elm_lang$core$Debug$log(_p1);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$AssertEditor$viewCondition = F2(
	function (model, condition) {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(condition.text),
				_1: {ctor: '[]'}
			});
	});
...
var _user$project$AssertEditor$Flags = F3(
	function (a, b, c) {
		return {assert: a, subjects: b, conditions: c};
	});
var _user$project$AssertEditor$Model = F3(
	function (a, b, c) {
		return {assert: a, subjects: b, conditions: c};
	});
var _user$project$AssertEditor$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: A3(_user$project$AssertEditor$Model, flags.assert, flags.subjects, flags.conditions),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$AssertEditor$Assert = F3(
	function (a, b, c) {
		return {subject: a, condition: b, operand: c};
	});
...
var _user$project$AssertEditor$SelectSubject = function (a) {
	return {ctor: 'SelectSubject', _0: a};
};
var _user$project$AssertEditor$view = function (model) {
	return A2(
...
var _user$project$AssertEditor$main = _elm_lang$html$Html$programWithFlags(
	{
					...
					return A2(
						...
						function (subjects) {
							return _elm_lang$core$Json_Decode$succeed(
								{assert: assert, conditions: conditions, subjects: subjects});
						},
						A2(
					...
					return A2(
						...
						function (operand) {
							return A2(
								...
								function (subject) {
									return _elm_lang$core$Json_Decode$succeed(
										{condition: condition, operand: operand, subject: subject});
								},
								A2(_elm_lang$core$Json_Decode$field, 'subject', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'operand', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'condition', _elm_lang$core$Json_Decode$string)))));

var Elm = {};
Elm['AssertEditor'] = Elm['AssertEditor'] || {};
if (typeof _user$project$AssertEditor$main !== 'undefined') {
    _user$project$AssertEditor$main(Elm['AssertEditor'], 'AssertEditor', undefined);
}
